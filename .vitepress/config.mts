  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        text: '基础科学',
        items: [
          { text: '物理', link: 'docs/物理/index' },
          { text: '数学', link: 'docs/数学/核磁共振' },
          { text: '计算机', link: 'docs/计算机/核磁共振' },
        ]
      },
      { text: '从零做起', link: 'docs/markdown-examples' },
      { text: '脑洞大开', link: 'docs/markdown-examples' },
      {
        text: '心情随笔',
        items: [
          { text: '出去逛逛', link: 'docs/markdown-examples' },
          { text: '随便聊聊', link: 'docs/markdown-examples' },
          { text: '动动小手', link: 'docs/markdown-examples' },
        ]
      },
    ],
    ...
    //       // collapsed: true,
    //       items: [
    //         { text: '量子力学', link: '/物理/量子力学' },
    //         { text: '傅里叶变换', link: '/物理/傅里叶变换' }
    //       ]
    //     }],
    //   '/数学/': [
    //     {
    ...
    footer: {
      ...
      copyright: 'Copyright © 2024-2024 NatureK'
    },
